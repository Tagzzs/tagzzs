    ...
    def _extract_metadata(self, soup: BeautifulSoup, url: str) -> MetaData:
        ...
        try:
            ...
            for meta in soup.find_all('meta'):
                ...
                if name and isinstance(name, str) and content and isinstance(content, str):
                    meta_dict[name.lower()] = content
                elif property_attr and isinstance(property_attr, str) and content and isinstance(content, str):
            ...
            if 'keywords' in meta_dict:
                meta_data.keywords = [k.strip() for k in meta_dict['keywords'].split(',')]
