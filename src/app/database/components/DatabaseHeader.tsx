...
export default function DatabaseHeader({
  ...
  return (
    <>
      <header className="h-12 md:h-12 flex items-center px-4 md:px-8 bg-black z-10 shrink-0 gap-2">
        ...
        <div className="text-xs text-zinc-500 font-medium flex items-center gap-2">
          {currentDetailItem
            ...
            : `${treeData
                ...
                treeData.find((c) => c.name === currentFilter)?.children.length
              } subcategories`}
        </div>
      </div>
    </>
