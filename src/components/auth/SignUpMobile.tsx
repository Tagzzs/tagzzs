...
export function SignUpMobile({ onSignIn, onSignUp, onSocialAuth }: SignUpMobileProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col max-w-sm mx-auto w-full pb-8">
        ...
        {/* Social Auth */}
        <div className="space-y-3 mb-6 animate-in fade-in duration-500 delay-200">
          <SocialButton
            provider="google"
        ...
        <div className="mt-6 text-center flex-shrink-0 animate-in fade-in duration-500 delay-400">
          <p className="text-sm text-white/50">
            ...
            <button
              onClick={onSignIn}
              className="text-purple-400 active:text-purple-300 transition-all duration-200 font-medium underline decoration-purple-400/30"
            >
              Sign in
            </button>
          </p>
